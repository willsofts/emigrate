...
let taskid = Arguments.getString(args,"extract_data_file_excel","-task","-t") as string;
let file = Arguments.getString(args,"./assets/extract/tso_ext.xlsx","-file","-f") as string;
...
async function testExtract() {
    ...
    let handler = new ExtractExcelHandler();
...
//node dist/test/test.extract.excel.js 
