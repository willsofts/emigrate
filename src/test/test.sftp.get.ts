...
let file = Arguments.getString(args,"/home/sbaadm/assets/tso.txt","-f","-file") as string;
let target = Arguments.getString(args,"d:\\exim\\assets\\sftp\\tso.txt","-t","-target") as string;
...
async function getFile(remotePath: string,localPath: string) {
    try {
