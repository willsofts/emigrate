...
let taskid = Arguments.getString(args,"extract_data_file_text_fix_length","-task","-t") as string;
let file = Arguments.getString(args,"./assets/extract/tso_fix.txt","-file","-f") as string;
...
//node dist/test/test.extract.text.fix.js -t extract_data_file_text_fix_length
