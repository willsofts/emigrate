...
let taskid = Arguments.getString(args,"test_file_text_error_abandon","-task","-t") as string;
let file = Arguments.getString(args,"./assets/tso_error.txt","-file","-f") as string;
